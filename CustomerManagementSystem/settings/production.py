...
from CustomerManagementSystem.settings import get_secret
SECRET_KEY = get_secret('SECRET_KEY') #'django-insecure-8*5cqb51_b^4iu18#buh07r6k8$he@@0bsk30^nx^xx@ue)+us'
